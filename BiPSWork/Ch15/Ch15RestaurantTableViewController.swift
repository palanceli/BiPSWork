//
//  Ch15RestaurantTableViewController.swift
//  BiPSWork
//
...
class Ch15RestaurantTableViewController: UITableViewController {
...
//        tableView.contentInsetAdjustmentBehavior = .never
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Ch15ShowRestaurantDetail"{
            if let indexPath = tableView.indexPathForSelectedRow{
                let destinationController = segue.destination as! Ch15RestaurantDetailViewController
