//
//  Ch13RestaurantTableViewController.swift
//  BiPSWork
//
...
class Ch13RestaurantTableViewController: UITableViewController {
...
//    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Ch13ShowRestaurantDetail"{
            if let indexPath = tableView.indexPathForSelectedRow{
                let destinationController = segue.destination as! Ch13RestaurantDetailViewController
