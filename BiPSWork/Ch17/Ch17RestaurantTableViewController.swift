//
//  Ch17RestaurantTableViewController.swift
//  BiPSWork
//
...
class Ch17RestaurantTableViewController: UITableViewController {
...
//        tableView.contentInsetAdjustmentBehavior = .never
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Ch17ShowRestaurantDetail"{
