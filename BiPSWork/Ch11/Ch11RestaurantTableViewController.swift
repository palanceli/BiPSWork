...
class Ch11RestaurantTableViewController: UITableViewController {
    ...
    fileprivate lazy var dataSource = configureDataSource(cellID: "ch11FavoriteCell")

    func configureDataSource(cellID: String)->UITableViewDiffableDataSource<Section, Ch11Restaurant>{
//        let cellID = "ch11FavoriteCell"
        
        let dataSource = UITableViewDiffableDataSource<Section, Ch11Restaurant>(
            tableView: tableView, cellProvider: {tableView, indexPath, restaurant in
                let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! Ch11RestaurantTableViewCell
